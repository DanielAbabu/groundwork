    ...
    },
    {
      ...
      spec: {
        ...
        notes: {
          ...
          "#APP_SERVER": "One redirect box cannot absorb ~2,900 req/s peak — size for at least two.",
          ...
          "APP_SERVER->CACHE": "The read path checks the cache first — mark it as a cache read/write.",
          "CACHE->DATABASE_PRIMARY": "Cache misses fall through to the system of record.",
          "!OBJECT_STORE": "Nothing here stores blobs — 4.6GB of short rows is a database, not object storage.",
